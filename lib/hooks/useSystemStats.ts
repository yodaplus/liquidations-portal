...
export function useSystemStats(): any {
  ...
  // ['Active Auctions', 'Inactive Auctions', 'Vaults requiring kick', 'USXD required for Auctions', 'Global max available']
...
export function useSystemStatsSidebar(ilk: string): any {
  ...
  // return data needed for each field in fieldMap and let format function do the rest
  // ['Undercollateralized Vaults', 'Active Auctions', 'Inactive Auctions', 'USXD required for Auctions', 'Limit per collateral available']
